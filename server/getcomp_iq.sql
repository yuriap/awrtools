select 'prompt TOP SQL #' || rownum || chr(13) || chr(10) || cmd, '-- &ordcol.(' || tot || ')'
  from (select 'define SQLID=' || sql_id || chr(13) || chr(10) || '&1.' cmd, &ordcol_expr. tot --,parsing_schema_name,module,action
          from (select db2.*
