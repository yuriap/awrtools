...
insert into awrconfig values ('MONITOR_PAUSE','10','Seconds between cube refresh in Monitor mode');
insert into awrconfig values ('MONITOR_ITERATIONS','100','Number of refresh iteration of cube in Monitor mode');
