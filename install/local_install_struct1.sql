...
begin
  dbms_scheduler.create_job(job_name => 'AWRTOOL_CLEANUP',
                            ...
                            job_action => 'begin AWRTOOLS_CUBE_ASH.CLEANUP_CUBE_ASH; AWRTOOLS_LOGGING.cleanup; AWRTOOLS_ONLINE_REPORTS.CLEANUP_ONLINE_RPT; AWRTOOLS_CACHE.CLEANUP_CACHE; end;',
